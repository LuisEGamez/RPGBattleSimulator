...
public class Parties {
    ...
    public static void createParty(){
        ...
        try{
            ...
            if(groupType.equals("1")){
                ...
                System.err.println(" You've created warrior: " + warName + "\n");
            }
            if(groupType.equals("2")){
                ...
                Parties.addCharacter("2", id, wizName, hpWiz, mana, intel);
                System.err.println(" You've created wizard: " + wizName + "\n");
            }
    ...
    public static void createRandomParty() {
        ...
        while(counterRandom > 0) {
            ...
            intelligence = Math.floor(Math.random()*(41)+ 10);
            warriorHp = Math.floor(Math.random()*(101) + 100);
            wizardHp = Math.floor(Math.random()*(51) + 50);
            stamina = (int) Math.floor(Math.random()*(41)+ 10);
            strength = Math.floor(Math.random()*(10) + 1);
            mana = (int) Math.floor(Math.random()*(41)+ 10);
            name = namesArray[(int) Math.floor(Math.random()*(2737))];
            switch((int) type) {
                case 1:
