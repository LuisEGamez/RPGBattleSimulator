...
public class Parties {
    ...
    private static int stamina = (int) Math.floor(Math.random()*(41)+ 10);
    private static double strength = Math.floor(Math.random()*(10) + 1);
    private static int mana = (int) Math.floor(Math.random()*(41)+ 10);
    private static double intelligence = Math.floor(Math.random()*(41)+ 10);
